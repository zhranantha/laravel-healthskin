<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto pt-16">
          ...
          <form wire:submit.prevent='save'>
            <div class="grid gap-y-4">
              ...
              <div>
                ...
                @error('name')
                <p class="text-xs text-red-600 mt-2" id="email-error">Please include a valid name so we can get back to you</p>
                @enderror
              </div>
              ...
              <div>
                ...
                @error('password')
                <p class="text-xs text-red-600 mt-2" id="email-error">Please include a valid password so we can get back to you</p>
                @enderror                </div>
              <!-- End Form Group -->
